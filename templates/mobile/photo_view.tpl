<div id="photo_view_{id}" class="photo_view" onClick="Photo.setEvent(event, '{close-link}')">
 ...
 <div style="background:#f5f5f5;margin-left:-12px;margin-right:-12px;margin-bottom:10px"><center><a href="/photo{uid}_{next-id}{section}" onClick="Photo.Show(this.href); return false" id="photo_href"><img id="ladybug_ant{id}" src="{photo}" style="max-width: 100%;" /></a></center></div>
 <div class="clr"></div>
