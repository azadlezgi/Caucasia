...
[comment]<div class="wall_fast_block" id="wall_fast_comment_{comm-id}" [owner]onMouseOver="ge('fast_del_{comm-id}').style.display = 'block'" onMouseOut="ge('fast_del_{comm-id}').style.display = 'none'"[/owner]>
