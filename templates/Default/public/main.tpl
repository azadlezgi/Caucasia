...
<div class="cover_profile_bg cover_groups_bg">
 <div class="cover_buts_pos">
  ...
  <div class="cover_loaddef_bg {cover-param}" {cover-param-4}>
   ...
   <div id="les10_ex2" {cover-param-5}><img src="{cover}" id="cover_img" alt="" /></div>
   <div id="cover_restart"></div>
  </div>
 </div>
</div>
[/admin]
[not-admin][cover]<div class="cover_all_user"><img src="{cover}" id="cover_img" alt="" {cover-param-5} /></div>[/cover][/not-admin]

<div class="ava fl_r" style="margin-right:0px" onMouseOver="groups.wall_like_users_five_hide()">
 [admin]<div class="cover_newava" {cover-param-7}><img src="{photo}" id="ava" /></div>[/admin]
 ...
 <div class="menuleft" style="margin-top:5px">
  ...
  [admin]<a href="/stats?gid={id}"><div>Статистика страницы</div></a>[/admin]
  ...
  <div class="publick_subscblock">
   ...
   <div id="no" class="{no}" style="text-align:left">
	...
	<a href="/groups/{id}" onClick="groups.exit2('{id}', '{viewer-id}'); return false">Отписаться</a>
   </div>
   <div class="clear"></div>
  </div>
 <div style="margin-top:7px">
  ...
  [videos]<div class="public_vlock cursor_pointer" onClick="Page.Go('/groups/{id}/videos'); return false">Видеозаписи</div>
 <div class="public_bg">
  ...
  <a href="/groups/{id}/videos" onClick="Page.Go(this.href); return false">Добавить видеозапись</a></div>[/novideo]
 </div>[/videos]
 [feedback]<div class="public_vlock cursor_pointer" onClick="groups.allfeedbacklist('{id}')">Контакты [yes][admin]<a href="/groups/{id}" class="fl_r" onClick="groups.allfeedbacklist('{id}'); return false">ред.</a>[/admin][/yes]</div>
 <div class="public_bg" id="feddbackusers">
  ...
  <a href="/groups/{id}" onClick="groups.addcontact('{id}'); return false">Добавить контакты</a></div>[/no]
 </div>[/feedback]
 [audios]<div class="public_vlock cursor_pointer" onClick="Page.Go('/groups/{id}/audio'); return false">Аудиозаписи</div>
 <div class="public_bg">
  ...
  <a href="/groups/{id}/audio" onClick="Page.Go(this.href); return false">Добавить аудиозапись</a></div>[/noaudio]
 </div>[/audios]
 <div id="fortoAutoSizeStyle"></div>
</div>
<div class="profiewr fl_l">
 ...
 [admin]<div class="public_editbg fl_l no_display" id="edittab1">
  ...
  <div class="mgclr clear"></div>
  <div class="texta">&nbsp;</div>
   <a href="/groups/{id}" onClick="groups.edittab_admin(); return false">Назначить администраторов &raquo;</a>
  <div class="mgclr"></div>
  <div class="texta">&nbsp;</div>
 ...
 [discussion]<a href="/forum{id}" onClick="Page.Go(this.href); return false" class="fl_l" style="text-decoration:none"><div class="albtitle" style="border-bottom:0px">{forum-num} <b id="langForum">Нет обсуждений</b></div></a>
 ...
 [admin]<div class="newmes" id="wall_tab" style="border-bottom:0px;margin-bottom:-5px">
  ...
  <div class="no_display" id="wall_textarea">
   <textarea id="wall_text" class="wall_inpst wall_fast_opened_texta" style="width:100%"
