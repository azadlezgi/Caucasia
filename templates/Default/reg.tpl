<div class="descr_site">
	<h1>Кавказская социальная сеть помогает объединению людей.</h1>
	<img src="/uploads/banner.png" alt="">
</div>
<h2 onClick="reg.step1(); return false" id="reg_lnk">Регистрация</h2>
...
<div class="input_hr" style="width:163px"></div>
<div class="clear"></div>
<div class="button_div fl_l"><button onClick="reg.step1(); return false" style="width:161px">Следующий шаг</button></div>
</div>
<div class="clear"></div>
</div>
