	...
	$(window).scroll(function(){
		if($('#type_page').val() == 'profile'){
			...
			if($(window).scrollTop() > $('#fortoAutoSizeStyleProfile').offset().top && !startResizeCss){
				startResizeCss = true;
				$('body').append('<div id="addStyleClass"><style type="text/css" media="all">.wallrecord{width:610px;margin-left:-210px}.infowalltext_f{font-size:11px}.public_likes_user_block{margin-left:458px}.wall_fast_opened_form{width:698px;margin-left:-150px}.wall_fast_block{width:710px;margin-top:2px;margin-left:-150px}.public_wall_all_comm{width:692px;margin-top:2px;margin-bottom:-2px}.player_mini_mbar_wall{width:710px;margin-bottom:0px}#audioForSize{min-width:700px}.wall_rec_autoresize{width:550px}.wall_fast_ava img{width:50px}.wall_fast_ava{width:60px}.wall_fast_comment_text{margin-left:57px}.wall_fast_date{margin-left:57px;font-size:11px}.public_wall_all_comm{margin-left:-150px}.size10{font-size:11px}</style></div>');
			}
		}
	});
	music.jPlayerInc();
...
<div class="cover_newava" {cover-param-7}>
	...
	<ul id="ava_menu">
		<li><a href="/" onClick="Profile.LoadPhoto(); return false;"><i class="fa fa-plus-square"></i><span>Загрузить новую фотографию</span></a></li>
		<li><a href="/" onClick="Profile.miniature(); return false;" {display-ava}><i class="fa fa-pencil-square"></i><span>Изменить миниатюру</span></a></li>
		<li><a href="/" onClick="Profile.DelPhoto(); return false;" id="del_pho_but" {display-ava}><i class="fa fa-bitbucket-square"></i><span>Удалить фотографию</span></a></li>
	</ul>
</div>
[/owner]
...
[owner]
<!-- <a href="/my_stats" onClick="Page.Go(this.href); return false;"><img class="icon stat_ic" src="{theme}/images/spacer.gif" alt="" /><div>Статистика страницы</div></a> -->
<!-- <a href="/docs" onClick="Page.Go(this.href); return false;"><img class="icon doc_ic" src="{theme}/images/spacer.gif" alt="" /><div>Мои документы</div></a> -->
...
[/owner]
[not-owner]
[blacklist][privacy-msg]<a href="/" onClick="messages.new_({user-id}); return false"><img class="icon mail_ic" src="{theme}/images/spacer.gif" alt="" /><div>Отправить сообщение</div></a>[/privacy-msg][/blacklist]
...
[no-blacklist]<a href="/" onClick="settings.addblacklist({user-id}); return false" id="addblacklist_but"><img class="icon compla_ic" src="{theme}/images/spacer.gif" alt="" /><div><span id="text_add_blacklist" title="Заблокировать">В черный список</span> <img src="/templates/Default/images/loading_mini.gif" alt="" id="addblacklist_load" class="no_display" /></div></a>[/no-blacklist]
...
[/logged]
[not-logged]
<div class="menuleft_not_logged" style="margin-top:5px">
	Пожалуйста, <a href="/" class="login_link">войдите</a> на сайт или <a href="/" class="reg_link">зарегистрируйтесь</a>, чтобы написать {name} {lastname} сообщение.
</div>
[/not-logged]
[blacklist]<div class="leftcbor">
 ...
 [notes]<a href="/notes/{user-id}" onClick="Page.Go(this.href); return false" style="text-decoration:none"><div class="albtitle">Заметки <span>{notes-num}</span></div></a>
...
<div class="profiewr">
 [owner]<div class="set_status_bg no_display" id="set_status_bg">
  <input type="text" id="status_text" class="status_inp" value="{status-text}" style="width:388px;" maxlength="255" onKeyPress="if(event.keyCode == 13)gStatus.set()" />
 ...
 <!-- <div class="profile_rate_pos">
  ...
  <div class="profile_rate_add" onClick="doLoad.data(1); rating.addbox('{user-id}')" onMouseOver="myhtml.title('1', 'Повысить рейтинг', 'rate', 1)" id="rate1"><img src="{theme}/images/icons/rate_ic.png" /></div>
...
[logged][privacy-wall]<div class="newmes" id="wall_tab" style="border-bottom:0px;margin-bottom:-5px">
  ...
  <div class="no_display" id="wall_textarea">
   <textarea id="wall_text" class="wall_inpst wall_fast_opened_texta" onKeyUp="wall.CheckLinkText(this.value)" onBlur="wall.CheckLinkText(this.value, 1)"></textarea>
