...
<div style="float:left;width:60px"><div class="ava_mini"><a href="/{link}{author-id}" onClick="Page.Go(this.href); return false"><img src="{ava}" alt="" /></a><div style="position:absolute;margin-left:4px">{online}</div></div></div>
<div style="float:left;width:558px;margin-left:0px">
...
[wall]<div class="public_likes_user_block no_display" id="public_likes_user_block{rec-id}" onMouseOver="groups.wall_like_users_five('{rec-id}'[wall-func], 'uPages'[/wall-func])" onMouseOut="groups.wall_like_users_five_hide('{rec-id}')" style="margin-left:468px">
...
<div class="no_display wall_fast_texatrea" id="fast_textarea_{rec-id}">
 <textarea class="wall_inpst fast_form_width wall_fast_text" style="height:50px;color:#000;margin:0px;;width:100%" id="fast_text_{rec-id}"
