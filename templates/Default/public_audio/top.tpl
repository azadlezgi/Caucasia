...
<div class="clear"></div>
<div id="seResult">
<div class="margin_top_10"></div><div class="allbar_title" style="margin-bottom:0px">{audio-num} | <a href="/{adres}" onClick="Page.Go(this.href); return false" style="font-weight:normal">К сообществу</a></div>
