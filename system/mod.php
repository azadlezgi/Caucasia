...
if(isset($_GET['go'])) {
	...
	$go = htmlspecialchars(strip_tags(stripslashes(trim(urldecode(mysqli_real_escape_string($_GET['go']))))));
	if (!$go) {
...
<title>'. ($metatags['title'] ? $metatags['title'] : $config['meta_title']) . ($metatags['title'] || $config['meta_title'] ? " | " : "") . $config['home'] .'</title>
'. ($metatags['description'] || $config['meta_description'] ? '<meta name="description" content="'. ($metatags['description'] ? $metatags['description'] : $config['meta_description']) .'">' : '') .'
'. ($metatags['keywords'] || $config['meta_keywords'] ? '<meta name="keywords" content="'. ($metatags['keywords'] ? $metatags['keywords'] : $config['meta_keywords']) .'">' : '') .'';
?>