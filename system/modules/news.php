						...
						if($expFriensList){
							foreach($expFriensList as $ac_id){
								...
								if(file_exists(ROOT_DIR.$row_action[1])){
									$comment .= "<a href=\"/videos/{$row['ac_user_id']}/{$row_action[0]}\" onClick=\"videos.show({$row_action[0]}, this.href, '/news/videos'); return false\" class=\"walltext_video\"><img src=\"{$row_action[1]}\" style=\"margin-right:5px\" /><i class=\"fa fa-play\"></i></a>";
									$action_cnt++;
								}
							}
								...
								foreach($attach_arr as $attach_file){
									...
									//Видео
										...
										if($cnt_attach_video == 1 AND preg_match('/(photo|photo_u)/i', $row_info['attach']) == false){
											...
											<div class=\"video_inline_icon\"></div><img src=\"/uploads/videos/{$attach_type[3]}/{$attach_type[1]}\" style=\"margin-top:3px\" width=\"390\" height=\"310\" /></div><div id=\"video_frame{$video_id}\" class=\"no_display\" style=\"padding-top:3px\">{$row_video['video']}</div><div class=\"video_inline_vititle\"></div><a href=\"/videos/{$attach_type[3]}/{$attach_type[2]}\" onClick=\"videos.show({$attach_type[2]}, this.href, location.href); return false\"><b>{$row_video['title']}</b></a>";
										
										} else {
											
											$attach_result .= "<div class=\"fl_l\"><a href=\"/videos/{$attach_type[3]}/{$attach_type[2]}\" onClick=\"videos.show({$attach_type[2]}, this.href, location.href); return false\"><div class=\"video_inline_icon video_inline_icon2\"></div><img src=\"/uploads/videos/{$attach_type[3]}/{$attach_type[1]}\" style=\"margin-top:3px;margin-right:3px\" align=\"left\" /><i class=\"fa fa-play\"></i></a></div>";
...
HTML;
					...
					//Если страница ответов "комменатрий к видеозаписи"
						...
						if(file_exists(ROOT_DIR.$photo_info[1])){
							$tpl->set('{comment}', stripslashes($photo_info[0])); 
							$tpl->set('{action-type}', $sex_text_4.' Вашу <a href="/videos/'.$user_id.'/'.$photo_info[2].'_sec=news" onClick="videos.show('.$photo_info[2].', this.href); return false">видеозапись</a>');
