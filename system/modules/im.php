						...
						if($attach_files){
							...
							foreach($attach_arr as $attach_file){
								...
								//Видео
									...
									$attach_result .= "<div class=\"im_text_video\"><a href=\"/videos/{$attach_type[3]}/{$attach_type[2]}\" onClick=\"videos.show({$attach_type[2]}, this.href, location.href); return false\"><img src=\"/uploads/videos/{$attach_type[3]}/{$attach_type[1]}\" style=\"margin-top:3px;margin-right:3px\" align=\"left\" /><i class=\"fa fa-play\"></i></a></div>";
					...
					if($row['attach']){
						...
						foreach($attach_arr as $attach_file){
							...
							//Видео
								...
								$attach_result .= "<div class=\"im_text_video\"><a href=\"/videos/{$attach_type[3]}/{$attach_type[2]}\" onClick=\"videos.show({$attach_type[2]}, this.href, location.href); return false\"><img src=\"/uploads/videos/{$attach_type[3]}/{$attach_type[1]}\" style=\"margin-top:3px;margin-right:3px\" {$size[3]} align=\"left\" /><i class=\"fa fa-play\"></i></a></div>";
