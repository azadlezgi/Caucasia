...
<div class="fllogall">Meta title:</div><input type="text" name="save[meta_title]" class="inpu" value="{$config['meta_title']}" /><div class="mgcler"></div>
<div class="fllogall">Meta description:</div><input type="text" name="save[meta_description]" class="inpu" value="{$config['meta_description']}" /><div class="mgcler"></div>
<div class="fllogall">Meta keywords:</div><input type="text" name="save[meta_keywords]" class="inpu" value="{$config['meta_keywords']}" /><div class="mgcler"></div>
