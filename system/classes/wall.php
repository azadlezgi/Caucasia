...
class wall {
    ...
    function select(){
        global $tpl, $db, $config, $user_id, $id, $for_user_id, $lang, $user_privacy, $check_friend, $server_time, $user_info, $logged;
...
HTML;
            ...
            $tpl->result[$this->compile] .= '<div class="azaz123" id="wall_fast_block_'.$row_wall['id'].'">';
    ...
    function comm_select(){
        global $tpl, $db, $config, $user_id, $id, $for_user_id, $fast_comm_id, $record_fasts_num, $logged;
